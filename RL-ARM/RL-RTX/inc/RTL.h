...
#ifndef NULL
 #ifdef __cplusplus       //定义这个符号就是表明当前环境是在C++环境中
...
extern U32      _os_init_mem(U32 p, void * pool, U32 size)    __SVC_0;
extern void *   _os_alloc_mem(U32 p, void * pool, U32 size)   __SVC_0;
extern U32      _os_free_mem(U32 p, void * pool, void *mem)   __SVC_0;
